...
데이터베이스의 구조를 정의하고 수정하데 사용하는 명령어

- 명령어
  - `CREATE` : 새로운 데이터베이스, table, view, index 등 데이터베이스 객체를 생성
  - `ALTER` : 기존 데이터베이스 객체의 구조 변경
  - `DROP` : 데이터베이스 객체 자체를 영구적으로 삭제
  - `TRUNCATE` :table의 데이터만 전부 삭제하고 구조는 남겨둠

#### DML

table에 저장된 데이터 자체를 조회하거나 변경하는데 사용하는 명령어
